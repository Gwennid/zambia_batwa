...
#Includes: removal of four Lozi individuals (that correspond to a different dataset) and restriction to biallelic SNPs. One analysis set includes ancient samples.
...
###
### See: prepare_data_Zambian_BaTwa.sh for the pre-processing.
