...
folder=/proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/Comparative_data/Omni2.5/1KGP_2015
plink --bfile zbatwa9_zbantu9_Schlebusch2012_4 --bmerge ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8.bed ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8.bim ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173 #91416 variants with 3+ alleles present
plink --bfile ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8 --flip zbatwa9_zbantu9_Schlebusch2012_1KGP173-merge.missnp --make-bed --out ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8f
plink --bfile zbatwa9_zbantu9_Schlebusch2012_4 --bmerge ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8f.bed ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8f.bim ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8f.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_2 #85
plink --bfile ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8f --exclude zbatwa9_zbantu9_Schlebusch2012_1KGP173_2-merge.missnp --make-bed --out ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8fe
plink --bfile zbatwa9_zbantu9_Schlebusch2012_4 --bmerge ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8fe.bed ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8fe.bim ${folder}/1000Genomes_final_onlyAutosomal_onlyCEU_CHB_YRI_LWK_MKK_8fe.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_3
#missingness filter
...
folder=/proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/Comparative_data/Omni2.5/Gurdasani_2015
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_4 --bmerge ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4.bed ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4.bim ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242 #74714 variants with 3+ alleles present
plink --bfile ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4 --flip zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242-merge.missnp --make-bed --out ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4f
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_4 --bmerge ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4f.bed ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4f.bim ${folder}/random_Amhara36_Oromo26_Somali36_Sotho36_Igbo36_Zulu36_Mandinka36_4f.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_2 #
#missingness filter
...
### Merge with Haber
folder=/proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/Comparative_data/Omni2.5/Haber_2016
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_3 --bmerge ${folder}/random_Sara36_Toubou35_3.bed ${folder}/random_Sara36_Toubou35_3.bim ${folder}/random_Sara36_Toubou35_3.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71 #588860
plink --bfile ${folder}/random_Sara36_Toubou35_3 --flip zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71-merge.missnp --make-bed --out ${folder}/random_Sara36_Toubou35_3f
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_3 --bmerge ${folder}/random_Sara36_Toubou35_3f.bed ${folder}/random_Sara36_Toubou35_3f.bim ${folder}/random_Sara36_Toubou35_3f.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_2
#missingness filter
...
exit 0") | sbatch -p core -n 2 -t 4:0:0 -A snic2019-8-14 -J mds_Omni2.5full -o mds_Omni2.5full.output -e mds_Omni2.5full.output --mail-user gwenna.breton@ebc.uu.se --mail-type=FAIL
...
exit 0") | sbatch -p core -n 1 -t 5:0:0 -A snic2019-8-14 -J PC_${root} -o PC_${root}.output -e PC_${root}.output
...
folder=/proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/Comparative_data/Omni1/Patin_2014
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_3 --bmerge ${folder}/Patin207_4.bed ${folder}/Patin207_4.bim ${folder}/Patin207_4.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207 #5787
plink --bfile ${folder}/Patin207_4 --flip zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207-merge.missnp --make-bed --out ${folder}/Patin207_4f
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_3 --bmerge ${folder}/Patin207_4f.bed ${folder}/Patin207_4f.bim ${folder}/Patin207_4f.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_2 #16
plink --bfile ${folder}/Patin207_4f --exclude zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_2-merge.missnp --make-bed --out ${folder}/Patin207_4fe
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_3 --bmerge ${folder}/Patin207_4fe.bed ${folder}/Patin207_4fe.bim ${folder}/Patin207_4fe.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_3
#Missingness
...
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_4 --bmerge ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4.bed ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4.bim ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52 #58419
plink --bfile ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4 --flip zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52-merge.missnp --make-bed --out ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4f
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_4 --bmerge ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4f.bed ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4f.bim ${folder}/Scheinfeldt_2019_Sabue_Hadza_Dinka_4f.fam --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_2
#Missingness
...
exit 0") | sbatch -p core -n 2 -t 1:0:0 -A snic2019-8-14 -J mds_Omni1full -o mds_Omni1full.output -e mds_Omni1full.output --mail-user gwenna.breton@ebc.uu.se --mail-type=FAIL,END
#Took 30 minutes.
...
root=zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex
smartpca -p ${root}_killr20.2_popsize36.par > ${root}_killr20.2_popsize36.smartpca.logfile
exit 0") | sbatch -p core -n 1 -t 30:0  -A snic2019-8-14 -J PC_${root} -o PC_${root}.output -e PC_${root}.output --mail-user gwenna.breton@ebc.uu.se --mail-type=FAIL,END
#Took 5 minutes.
...
plink --bfile ${root}_3fex --indep-pairwise 50 10 0.1 --make-bed --out ${root}_4fex #931135 of 1193229 variants removed
...
plink --bfile ${root}_4fex --indep-pairwise 50 10 0.1 --make-bed --out ${root}_5fex #229368 of 344629
...
cd ../
rm -R ad_${k}_${i}
exit 0") | sbatch -p core -n 1 -t 24:0:0 -A snic2019-8-14 -J ad_${k}_${i}_Omni2.5full -o ad_${k}_${i}_Omni2.5full.output -e ad_${k}_${i}_Omni2.5full.output --mail-user gwenna.breton@ebc.uu.se --mail-type=FAIL
done
done
...
cd ../
rm -R ad_${k}_${i}
exit 0") | sbatch -p core -n 1 -t 8:0:0 -A snic2019-8-14 -J ad_${k}_${i}_Omni1full -o ad_${k}_${i}_Omni1full.output -e ad_${k}_${i}_Omni1full.output --mail-user gwenna.breton@ebc.uu.se --mail-type=FAIL
done
done
...
#Edit 20200416: Not redoing it with the new merged dataset (after HWE correction) because it was not very informative.
#cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/
...
#### PCA with YRI, Baka, Juhoansi, Bangweulu, Kafue, and the three Zambian Bantu-speaker populations.

cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/
grep -e YRI -e Baka_Cam -e Juhoansi -e Bangweulu -e Kafue -e Zambia zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex.fam > zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex --keep zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp --geno 0.1 --mind 0.1 --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp_2

##run smartpca
root=zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp_2
cp /proj/uppstore2017183/b2012165_nobackup/private/Seq_project/scripts/parfile.par temppar
#set: killr2 YES, r2thresh 0.2, numoutlier 0, popsizelimit 36
sed "s/infile/${root}/g" temppar |   sed "s/outfile/${root}_killr20.2_popsize36/g"  | sed "s/popsizelimit:     20/popsizelimit:     36/g" | sed "s/killr2:           YES/killr2:           YES/g"   > ${root}_killr20.2_popsize36.par
rm temppar
...
##run smartpca - Zambian projected. (ran 20200506 because previously there was a mistake in the code)
root=zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_YRI_Baka-Cam_Juhoansi_B_Z_ZambiaBantusp_2
cp /proj/uppstore2017183/b2012165_nobackup/private/Seq_project/scripts/parfile.par temppar
#set: killr2 YES, r2thresh 0.2, numoutlier 0, popsizelimit 36
...
#### PCA with Nzebi, Baka, Juhoansi, Bangweulu, Kafue

cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/
grep -e Nzebi -e Baka_Cam -e Juhoansi -e Bangweulu -e Kafue zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex.fam > zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex --keep zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z
plink --bfile zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z --geno 0.1 --mind 0.1 --make-bed --out zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z_2

##run smartpca
root=zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z_2
cp /proj/uppstore2017183/b2012165_nobackup/private/Seq_project/scripts/parfile.par temppar
#set: killr2 YES, r2thresh 0.2, numoutlier 0, popsizelimit 36
sed "s/infile/${root}/g" temppar |   sed "s/outfile/${root}_killr20.2_popsize36_B_K_projected/g"  | sed "s/popsizelimit:     20/popsizelimit:     36/g" | sed "s/killr2:           YES/killr2:           YES/g"   > ${root}_killr20.2_popsize36_B_K_projected.par
rm temppar
...
sed "s/\t/ /g" fileComb > ${root}.pedind
rm file1a; rm file2a; rm fileComb
echo -e 'poplistname:\tBaka-Cam_Juhoansi_Nzebi_poplist' >> ${root}_killr20.2_popsize36_B_K_projected.par

(echo '#!/bin/bash -l'
echo "
cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/
module load bioinfo-tools eigensoft/7.2.0
root=zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_Patin207_Scheinfeldt52_4fex_Nzebi_Baka-Cam_Juhoansi_B_Z
smartpca -p ${root}_killr20.2_popsize36_B_K_projected.par > ${root}_killr20.2_popsize36_B_K_projected.smartpca.logfile
exit 0") | sbatch -p core -n 1 -t 30:0  -A snic2018-8-397 -J PC_${root}_B_K_projected -o PC_${root}_B_K_projected.output -e PC_${root}_B_K_projected.output --mail-user gwenna.breton@ebc.uu.se --mail-type=FAIL,END
...
# See notes and thoughts in lab book Project3. I decided to work with the Omni2.5 merge because it has a higher density. But if we want the eAfr HG and the RHG we will need to use the Omni1 merge.
interactive -p core -n 1 -A g2019029 -t 3:00:0
cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/
module load bioinfo-tools plink/1.90b4.9

inprefix=zbatwa9_zbantu9_Schlebusch2012_1KGP173_Gurdasani242_Haber71_
grep -e schus -e ZAM27 -e ZAM66 ${inprefix}3fex.fam > ${inprefix}3fex.exclude
plink --bfile ${inprefix}3fex --remove ${inprefix}3fex.exclude --make-bed --out ${inprefix}3fex_3ex 
plink --bfile ${inprefix}3fex_3ex --geno 0.05 --mind 0.05 --make-bed --out ${inprefix}3fex_3ex_2
#I could filter for MAF but I would need to do that in some kind of grouping - skipping that at the moment.
plink --bfile ${inprefix}3fex_3ex_2 --homozyg --homozyg-snp 50 --homozyg-kb 500 --homozyg-density 50 --homozyg-gap 100 --homozyg-window-snp 50 --homozyg-window-het 1 --homozyg-window-missing 5 --homozyg-window-threshold 0.05 --out ${inprefix}3fex_3ex_2_roh1 #found 60856 ROH
plink --bfile ${inprefix}3fex_3ex_2 --homozyg --homozyg-snp 50 --homozyg-kb 1000 --homozyg-density 50 --homozyg-gap 100 --homozyg-window-snp 50 --homozyg-window-het 1 --homozyg-window-missing 5 --homozyg-window-threshold 0.05 --out ${inprefix}3fex_3ex_2_roh2 #found 11541 ROH
plink --bfile ${inprefix}3fex_3ex_2 --homozyg --homozyg-snp 100 --homozyg-kb 1000 --homozyg-density 50 --homozyg-gap 100 --homozyg-window-snp 50 --homozyg-window-het 1 --homozyg-window-missing 5 --homozyg-window-threshold 0.05 --out ${inprefix}3fex_3ex_2_roh3 #found 11536 ROH > Changing the minumum number of SNPs in the RoH does not seem to make much of a difference.

# Gather some information.

## n_ROH by population (total) (Caution! Number of individuals should be accounted for somehow).
for POP in Amhara Bangweulu CEU Chad_Sara Chad_Toubou CHB ColouredAskham GuiGhanaKgal Igbo Juhoansi Kafue Karretjie Khomani Khwe LWK Mandinka MKK Nama Oromo SEBantu Somali Sotho SWBantu Xun YRI Zambia_Bemba Zambia_Lozi Zambia_TongaZam Zulu; do
n_ROH=$(grep ${POP} ${inprefix}3fex_3ex_2_roh1.hom | wc -l|cut -f1)
echo -e "${POP}\t${n_ROH}" >> ${inprefix}3fex_3ex_2_roh1.nROHbypop
done

# TODO If I want to gather more such information, I can take as example what I did for the ABC. But I really want to do plots so better to use R directly I think.
# I will do that locally and using Rstudio.
...
#First, extract the Y chromosome and do some basic filtering (geno, ind). I will include the individuals which were estimated to be male by the sequencing platform (only for the BaTwa samples). Then, run SNAPPY.
module load bioinfo-tools plink/1.90b4.9
cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020
grep -P "^24\t" ../preparedata_Oct2018/zbatwa1.bim >> chr24_Y #Y
plink --bfile  ../preparedata_Oct2018/zbatwa1f --extract chr24_Y --make-bed --out zbatwachrY_1 #2,221,421 remain.
plink --bfile zbatwachrY_1 --recode --out zbatwachrY_1
#I created with grep a file with the individuals that I want to keep (plus the fake individual).
plink --bfile zbatwachrY_1 --keep zbatwachrY_1_males --make-bed --out zbatwachrY_2
plink --bfile zbatwachrY_2 --recode --out zbatwachrY_2
#warning: "Nonmissing nonmale Y chromosome genotype(s) present; many commands treat these as missing." Ha! Maybe it is because I do not have the sex of the samples in the .fam...
#I modified manually the .fam (changed the fifth column to 1 i.e. male).
plink --bfile zbatwachrY_2 --mind 0.1 --geno 0.1 --make-bed --out zbatwachrY_3
#replace rs and kgp type SNP names with SNPs that have new name in chr-baseposition format, i.e. 2-347898 
infile="zbatwachrY_3"
cut -f1,4 ${infile}.bim | sed "s/\t/-/g" > mid
cut -f1 ${infile}.bim > first
...
cut -f2 ${infile}.bim | sort | uniq | sort | uniq > wo_dup
comm -23 with_dup wo_dup > dupl
plink --bfile zbatwachrY_3 --exclude dupl --make-bed --out zbatwachrY_4

#The SNAPPY manual recommends to flip the alleles so that they match hg37. But what reference genome can I use? Maybe some files coming together with snappy.
#I looked at the first variant in test_data/TGP_chrY_MEGA.bim. The order of the alleles is different from ref_files/pos_to_allele.txt. Ah ok! The order might not matter, but rather the strand (i.e. in my .bim I have T C and in the other files it is G A). How could I change that? Maybe I can try to merge with the test example and hope that there will be a good overlap. Otherwise I need to find a better way, or create my own plink fileset using ref_files/pos_to_allele.txt somehow.
#First I need to rename the variants in the test dataset.
cd /proj/uppstore2018150/private/Programs/snappy-master/test_data/
infile="TGP_chrY_MEGA"
cp ${infile}.bim ${infile}_original.bim
cut -f1,4 ${infile}.bim | sed "s/\t/-/g" > mid
cut -f1 ${infile}.bim > first
cut -f3- ${infile}.bim > last
paste first mid last > ${infile}.bim
cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020
plink --bfile /proj/uppstore2018150/private/Programs/snappy-master/test_data/TGP_chrY_MEGA --bmerge zbatwachrY_4.bed zbatwachrY_4.bim zbatwachrY_4.fam --make-bed --out zbatwachrY_4_TGP_chrY_MEGA_1 #meuh, only 648 variants in commun unfortunately.
#I cannot find a plink fileset for hg37 online either. So: make my own!
#MAP: chr code | variant identifier | position in cM | base-pair coordinate: 24 | 24:pos | 0 | pos where pos=taken from ref_files/pos_to_allele.txt
#PED: FID | IID | 0 | 0 | sex | phenotype | genotype (2*number of variants) : I guess for the genotype I should make it heterozygous at all positions, even if that is impossible? (well, I have the fake individual which is like that).

#MAP file
cp /proj/uppstore2018150/private/Programs/snappy-master/ref_files/pos_to_allele.txt tmp #29587 lines
tail -n 29586 tmp > tmp2; mv tmp2 tmp
cut -f1 tmp > pos
#for i in {1..29586}; do echo 24 >> chr ; done
paste chr pos | tr "\t" "-" > col2
#for i in {1..29586}; do echo 0 >> col3 ; done
paste chr col2 col3 pos > hg37_chrY.map

#PED file
cat tmp | cut -f2,3 | tr "\t" "\n" | tr "\n" " " > genotype
echo "hg37 hg37 0 0 1 -9" > hg37
paste hg37 genotype | tr "\t" " " > hg37_chrY.ped

#Let's try.
plink --file hg37_chrY --make-bed --out hg37_chrY
plink --bfile hg37_chrY  --bmerge zbatwachrY_4.bed zbatwachrY_4.bim zbatwachrY_4.fam --make-bed --out zbatwachrY_4_hg37
#only 918 overlap...
#But since this is used as a reference, I suppose that only the overlaping variants will be informative anyway? I will flip them (44 variants), it should not harm.
plink --bfile zbatwachrY_4 --flip zbatwachrY_4_hg37-merge.missnp --make-bed --out zbatwachrY_4f
plink --bfile zbatwachrY_4f --remove fake_ex --make-bed --out zbatwachrY_4f_fex

cd /proj/uppstore2018150/private/Programs/snappy-master
module load bioinfo-tools plink/1.90b4.9
python SNAPPY_v0.1.py --infile /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/zbatwachrY_4f_fex --out /proj/uppstore2018150/private/results/Yhaplogroups/20200501_SNAPPY/zbatwachrY_4f_fex #not working
python SNAPPY_v0.1.py --infile test_data/TGP_chrY_MEGA --min_hap_score 0.2 --out /proj/uppstore2018150/private/results/Yhaplogroups/20200501_SNAPPY/TGP_chrY_MEGA #not working either.

#it WAS the Python version.
module load bioinfo-tools python/2.7.6
cp /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020/zbatwachrY_4f_fex* .
python SNAPPY_v0.1.py --infile zbatwachrY_4f_fex --out zbatwachrY_4f_fex_Yhg
#Success!
mv zbatwachrY_4f_fex_Yhg* /proj/uppstore2018150/private/results/Yhaplogroups/20200501_SNAPPY/

#TODO question: should I exclude indels?
#exclude indels TODO ask CS whether this should be done for the Y chromosome (maybe there is some relevant information in there).
rm indellist; touch indellist
grep -P "\tI" zbatwa2.bim >> indellist
...
#First, extract the mt and do some basic filtering (geno, ind).
module load bioinfo-tools plink/1.90b4.9
cd /proj/uppstore2018150/private/tmp/prepareanalysisset_March2020
##BaTwa
plink --bfile ../preparedata_Oct2018/zbatwa1f --chr 26 --biallelic-only strict --mind 0.1 --geno 0.1 --make-bed --out zbatwamt_1 #79 individuals, 248 markers (start: 81, 272).
infile="zbatwamt_1"
cut -f1,4 ${infile}.bim | sed "s/\t/-/g" > mid
cut -f1 ${infile}.bim > first
cut -f3- ${infile}.bim > last
...
cut -f2 ${infile}.bim | sort | uniq | sort | uniq > wo_dup
comm -23 with_dup wo_dup > dupl
plink --bfile zbatwamt_1 --exclude dupl --make-bed --out zbatwamt_2
#I changed manually the family names in zbatwamt_2.fam.
##Bantu-speakers from Zambia
plink --bfile zbantu1 --chr 26 --biallelic-only strict --mind 0.1 --geno 0.1 --make-bed --out zbantumt_1
infile="zbantumt_1"
cut -f1,4 ${infile}.bim | sed "s/\t/-/g" > mid
cut -f1 ${infile}.bim > first
cut -f3- ${infile}.bim > last
...
cut -f2 ${infile}.bim | sort | uniq | sort | uniq > wo_dup
comm -23 with_dup wo_dup > dupl
plink --bfile zbantumt_1 --exclude dupl --make-bed --out zbantumt_2

#Merge the two.
plink --bfile zbatwamt_2 --bmerge zbantumt_2.bed zbantumt_2.bim zbantumt_2.fam --make-bed --out zbatwa_zbantu_mt #Worked directly. I decided to not filter for genotyping rate because I think the extra markers might be useful for the few samples who have them.

#Exclude fake.
plink --bfile zbatwa_zbantu_mt --remove fake_ex --make-bed --out zbatwa_zbantu_mt_fex

#Create VCF.
plink --bfile zbatwa_zbantu_mt_fex --recode vcf --out zbatwa_zbantu_mt_fex

#Continuing locally (Uppmax maintenance window). CFL sent me some code (email 20200505).
cd /home/gwennabreton/Documents/PhD/Projects/Project3_Zambia_SNParray/analyses/VT2020/mt_haplogroups
#I installed haplogrep locally (but possibly I want to use the online interface).
##Trying first without the tricks recommended by CFL.
./haplogrep classify --in zbatwa_zbantu_mt_fex.vcf --format vcf --out zbatwa_zbantu_mt_fex_haplogroups_test1.txt --chip
cat zbatwa_zbantu_mt_fex_haplogroups_test1.txt | cut -f3 | sort | uniq -c
#Majority of H haplogroups (H1, H3, H3). Apparently these are most frequent in Europeans. That is weird. The rest: L0a, L1, L3.
#The quality of the assignment is pretty low (0.5 for a bunch of individuals in particular the Zambian Bantu-speakers).
./haplogrep classify --in zbatwa_zbantu_mt_fex.vcf --format vcf --out zbatwa_zbantu_mt_fex_haplogroups_test1.txt --chip --extend-report
sed "s/H2a2a1/Unclassified/g" < zbatwa_zbantu_mt_fex_haplogroups_test1.txt > zbatwa_zbantu_mt_fex_haplogroups_test1mod.txt
cut -f1,3,4,5 zbatwa_zbantu_mt_fex_haplogroups_test1mod.txt > zbatwa_zbantu_mt_fex_haplogroups_test1modkey.txt

#Only seven individuals have haplogroups with > 70% haplogrep rank, 42 with > 60% (none of them the Zambian Bantu-speakers - why???). Could that be because they are less heterozygous? But shouldn't they all have Bantu-speaker haplogroups?

##Now with CFS instructions. (Though I have the feeling that they are redundant with using the --chip flag.)
DB=zbatwa_zbantu_mt_fex
# Create both position and mutation lists
cut -f2 ${DB}.vcf | paste -s > ${DB}_positions
# Manually remove everything before POS in ${DB}_positions (including POS)
sed -i 's/\t/; /g' ${DB}_positions

# Find mutations in Haplogrep2 (https://haplogrep.i-med.ac.at/app/index.html) importing your ${DB}.vcf file
# Not working :( (issue with the website, likely temporary)
# So I cannot do the following steps (I do not understand how to do them on the CL).
# After finding mutations, export table with the mutation list for each sample, and create a new Haplogrep input. Just change in Range column, instead of the full mitogenome put the full position list (${DB}_positions). Example:

SampleID Range Haplogroup Polymorphisms
Sample_name ${DB}_mtDNA_positions ? Detected_mutations

# Export the final table and replace H2a2a1 haplogroups for Unclassified haplogroups. Consider mtDNA-Hg with more than 70% Haplogrep Rank.

## Testing with the other reference.
./haplogrep classify --in zbatwa_zbantu_mt_fex.vcf --format vcf --out zbatwa_zbantu_mt_fex_haplogroups_test2.txt --chip --rsrs
#still gives a result of sort... The ones that had H2a2a1 get mtMRCA instead (which is similar to the "Unclassified haplogroups" mentioned by CFL), and the H1ah2 get C4a1a5. For the L-haplogroups, quite similar.
